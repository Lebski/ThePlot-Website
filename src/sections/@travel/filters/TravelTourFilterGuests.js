...
// @mui
import { Box, Stack, Divider, Typography, Popover, InputAdornment } from '@mui/material';
// components
...
TravelTourFilterGuests.propTypes = {
...
export default function TravelTourFilterGuests({ guests, setGuests, sx }) {
