...
CareerJobSalaryFilter.propTypes = {
  filterSalary: PropTypes.arrayOf(PropTypes.number),
  onChangeSalary: PropTypes.func,
};

export default function CareerJobSalaryFilter({ filterSalary, onChangeSalary }) {
