...
ComponentsUIPage.propTypes = {
  components: PropTypes.array.isRequired,
};

export default function ComponentsUIPage({ components }) {
  return (
...
ComponentsUIPage.getLayout = function getLayout(page) {
